    ...
    createUserAdmin: async (admin) => {
        ...
        try {
            ...
            if (UsuarioExistente) {
                ...
                const administradores = await db_pool.one('INSERT INTO personal.administrador(usuario_id,nombres,apellidos,dni,fecha_nacimiento,zona_trabajo_id) VALUES($1,$2,$3,$4,$5,$6) RETURNING *',
